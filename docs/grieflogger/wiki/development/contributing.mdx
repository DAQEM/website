---
title: Contributing
description: Guidelines for contributing to the GriefLogger project, including setting up a development environment and submitting pull requests.
---
...
Start by forking the [official GriefLogger repository](https://github.com/DAQEM/GriefLogger) on GitHub to your own account.
...
The project requires **Java 21 (Temurin/OpenJDK)**. Make sure this is the JDK your system uses for Gradle.
...
Always create a new branch for your changes. Base your branch off the `-dev` branch for the relevant Minecraft version (e.g., `1.21.9-dev`).
```bash
