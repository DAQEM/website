...
The results of an inspection are displayed directly in your chat. If the history is long, it will be broken into multiple pages. You can navigate these pages using the `/gl page` command. See the **[Pages](./Pages)** documentation for more details.