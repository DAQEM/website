...
description: Guidelines for reporting bugs and issues with GriefLogger to help the development team address them effectively.
---
...
**Before you post, please [search the existing issues](https://github.com/DAQEM/GriefLogger/issues) to see if someone has already reported the same problem.**

### How to Create a Bug Report

All bug reports should be submitted to our **[GitHub Issue Tracker](https://github.com/DAQEM/GriefLogger/issues)**.
...
<Admonition type="warning" title="Sanitize Your Data!">
