...
export const CodeBlock = ({
    ...
    return (
        <CodeBlockContext.Provider value={{ value, onValueChange, data }}>
            <div
                className={cn("size-full mc-card p-0", className)}
                {...props}
            />
...
export const CodeBlockHeader = ({
    ...
    <div
        className={cn(
            "flex flex-row items-center border-b-4 border-card-background-light p-1",
            className,
        )}
        {...props}
    />
...
export const CodeBlockFilename = ({
    ...
    return (
        <div className="flex items-center gap-2 px-4 py-1.5 text-sm" {...props}>
...
export const CodeBlockCopyButton = ({
    ...
    return (
        <Button
            className={cn(
                "shrink-0 text-muted-foreground hover:bg-card hover:text-foreground transition-colors",
                className,
            )}
            onClick={copyToClipboard}
            size="icon"
